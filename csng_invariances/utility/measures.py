...
def model_predictions_repeats(
    model, dataloader, data_key, device="cpu", broadcast_to_target=False
):
    """
    ...
    Returns:
        ...
        output: responses as predicted by the network for the unique images. If broadcast_to_target, returns repeated outputs of shape [num_images][num_reaps, num_neurons] else (default) returns unique outputs of shape [num_images, num_neurons]
    """
